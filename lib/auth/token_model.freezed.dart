...
class _$_TokenModel implements _TokenModel {
  const _$_TokenModel({this.fcm_token});
  ...
  @override
  String toString() {
    return 'TokenModel(fcm_token: $fcm_token)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, fcm_token);
...
abstract class _TokenModel implements TokenModel {
  const factory _TokenModel({final String? fcm_token}) = _$_TokenModel;
