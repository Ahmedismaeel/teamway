...
class AddProjectCommentView extends StatefulWidget {
  final String projectId;
  AddProjectCommentView({
    super.key,
    required this.projectId,
  });

  @override
  State<AddProjectCommentView> createState() => _AddProjectCommentViewState();
}

class _AddProjectCommentViewState extends State<AddProjectCommentView> {
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                SubmitWidget(
                  onTap: (ref) {
                    ref.read(addCommentProjectProvider.notifier).addComment(
