...
class _$_ErrorModel implements _ErrorModel {
  const _$_ErrorModel({this.responseCode, this.message});
  ...
  @override
  String toString() {
    return 'ErrorModel(responseCode: $responseCode, message: $message)';
  }
...
abstract class _ErrorModel implements ErrorModel {
  const factory _ErrorModel({final int? responseCode, final String? message}) =
      _$_ErrorModel;
